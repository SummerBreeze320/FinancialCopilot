...
import com.financial.copilot.agent.core.infra.dag.model.InputBinding;
    ...
    public static boolean isReady(String nodeId, ExecutionGraph graph, Function<String, NodeStatus> statusProvider) {
        ...
        for (String upId : upstreams) {
            ...
            boolean continuedTimeout = s == NodeStatus.TIMEOUT && upstream != null
                    && upstream.getFailurePolicy() == com.financial.copilot.agent.core.infra.dag.model.FailurePolicy.CONTINUE;
