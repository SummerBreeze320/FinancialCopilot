...
import com.financial.copilot.agent.core.infra.dag.model.FailurePolicy;
...
import com.financial.copilot.agent.core.infra.dag.artifact.payload.FundResearchResult;
import com.financial.copilot.agent.core.infra.dag.planner.tool.MetricRAGTool;
import com.financial.copilot.agent.core.infra.dag.planner.tool.SkillRegistryTool;
...
import com.financial.copilot.agent.core.infra.dag.runtime.resource.ResourceRequirement;
...
class DynamicReplanTest {
    ...
    void readyNodeSkippedByPatchIsRemovedFromDispatchQueue() throws Exception {
        ...
        }, new ResourceManager(Map.of(com.financial.copilot.agent.core.infra.dag.runtime.resource.ResourceType.AGENT, 2)),
        ...
        assertThat(result.nodeStatuses()).containsEntry("victim", com.financial.copilot.agent.core.infra.dag.model.NodeStatus.SKIPPED);
    }
    ...
    void appliedPatchIsCheckpointedBeforeAddedNodeCompletes() throws Exception {
        ...
        try {
            ...
            assertThat(saved.graph().nodes()).extracting(com.financial.copilot.agent.core.infra.dag.model.ExecutionGraphSnapshot.NodeSnapshot::nodeId)
                    .contains("added");
        } finally {
    ...
    void removeAndSkipPatchOperationsUpdateRunCompletion() throws Exception {
        ...
        assertThat(result.nodeStatuses()).containsEntry("root", com.financial.copilot.agent.core.infra.dag.model.NodeStatus.SUCCEEDED);
        assertThat(result.nodeStatuses()).containsEntry("skipped", com.financial.copilot.agent.core.infra.dag.model.NodeStatus.SKIPPED);
        assertThat(result.nodeStatuses()).containsEntry("added", com.financial.copilot.agent.core.infra.dag.model.NodeStatus.SUCCEEDED);
    }
