...
public record AgentToolAudit(Long id, UUID conversationId, Long assistantMessageId, Long userId, UUID runId,
                             String nodeId, String agentName, String toolCallId, String toolName,
                             ToolAuditStatus status, Map<String, Object> arguments, String resultSummary,
                             String resultHash, List<String> artifactIds, Instant startedAt, Instant completedAt,
                             Long durationMs, String errorCode, String errorMessage) {
    public AgentToolAudit {
        Objects.requireNonNull(conversationId);
        Objects.requireNonNull(assistantMessageId);
