package com.financial.copilot.domain.platform.user.entity;

import com.financial.copilot.domain.platform.user.enums.InvestmentHorizon;
import com.financial.copilot.domain.platform.user.enums.InvestmentStyle;
import com.financial.copilot.domain.platform.user.enums.RiskToleranceLevel;
